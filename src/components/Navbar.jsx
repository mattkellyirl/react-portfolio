...
function Navbar() {
  return (
    // <!--Navigation Bar-->
    <nav class="border-b bg-green-100">
      <div class="container mx-auto">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-center md:justify-between mx-auto px-6 bg-red-100">
          ...
          <div className="w-full text-center md:block md:text-start md:w-auto">
            <ul className="flex flex-col font-medium mt-4 rounded-lg md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0">
              ...
              <li>
                <Link
                  to="/contact"
                  className="block py-2 px-0 text-neutral-950 font-semibold transition-colors duration-300 hover:text-indigo-700"
                  aria-current="page"
                >
                  Contact
                </Link>
